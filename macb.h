...
struct macb_queue {
	...
	struct dma_prealloc *tx_dma_mem;
...
struct macb {
	...
	uint64_t txdma_time;
	uint64_t txqueue_time, txtotal_time, txirq_time,txirq_short_time;
	uint64_t txirq_base_count, txirq_quick_count,dbg_bs, macbrx;
	...
	struct dma_prealloc *rx_dma_mem;
